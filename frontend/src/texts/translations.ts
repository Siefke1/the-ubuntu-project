...
export const translations: Record<string, Translations> = {
  en: {
    welcome: {
      ...
      description:
        "Our idea is simple. We founded a Tech Company and our product is a Social Media Platform. So what's the deal? If you sign up on our platform, you will become a silent partner in our company, meaning any profit generated by the platform, will be divided between <strong>all</strong> of it's users.",
      button: "Sounds interesting?",
    },
    about: {
      title: "Here's the plan...",
      paragraph1:
        "Ever asked youself how Tech Companies can make billions of profits, while running a seemlingly 'free' product? The answer is data and attention. Advertisers, Marketing Firms and Data Brokers are willing to pay big amounts of money to those, who own the attention. Our question is not, whether it is fair to trade data in exchange for services, our question is why shouldn't we be the ones selling it? It is our own resources after all. So our business model isn't about fast profits  — it's about <strong>ownership</strong>. Ownership of the data and spaces we build and use together.",
      paragraph2Title: "Inspirations...",
      paragraph2:
        'Examples like the <a href="https://en.wikipedia.org/wiki/GameStop_short_squeeze" style="color: inherit;" target="_blank" rel="noopener noreferrer">GameStop Short-Squeeze</a> demonstrated impressively, how much impact we as consumers really have, as long as we bundle our efforts. In a time where Tech Companies are making unprecedented profits, while global inequality is rising by the minute, we have come to the overdue conclusion, that in order to fundamentally succeed, we will need each other.',
      paragraph3Title: "Imagine...",
      paragraph3:
